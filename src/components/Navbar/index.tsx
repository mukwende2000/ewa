...
function index() {
  return (
    <nav className="lg:sticky top-10 py-5 lg:h-[90%] rounded-md lg:m-5 text-white bg-gray-700">
      <Container styles="flex lg:flex-col justify-between lg:gap-20 items-center">
        ...
        />
        <div className="flex lg:flex-col md:px-5 gap-10 md:gap-16">
          <NavLink
            className="text-[rgb(90,106,144)] hover:text-[rgb(252,71,71)]"
            aria-label="Go to Home Page"
            to={"/"}
          >
            <PiSquaresFourFill fontSize={30} />
          </NavLink>
          <NavLink
            className="text-[rgb(90,106,144)] hover:text-[rgb(252,71,71)]"
